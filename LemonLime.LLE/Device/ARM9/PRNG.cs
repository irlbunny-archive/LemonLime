...
namespace LemonLime.LLE.Device.ARM9
{
    class PRNG : CPU.Device
    {
        ...
        public uint   ReadWord (uint Offset) { return (uint)  this.RNG.Next(); }
        public ushort ReadShort(uint Offset) { return (ushort)this.RNG.Next(); }
        public byte   ReadByte (uint Offset) { return (byte)  this.RNG.Next(); }
